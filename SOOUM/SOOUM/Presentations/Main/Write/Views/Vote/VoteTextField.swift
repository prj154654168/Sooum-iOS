...
protocol VoteTextFieldDelegate: AnyObject {
    
    func textFieldShouldReturn(_ textField: UITextField)
}

final class VoteTextField: UIView {
    
    enum Constants {
        static let maxCharacters: Int = 20
    }
    ...
    // MARK: VoteTextFieldDelegate
    
    weak var delegate: VoteTextFieldDelegate?
...
extension VoteTextField: UITextFieldDelegate {
