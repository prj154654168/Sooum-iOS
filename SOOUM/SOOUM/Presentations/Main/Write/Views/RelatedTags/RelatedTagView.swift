...
class RelatedTagView: UICollectionViewCell {
    
    static let cellIdentifier = String(reflecting: RelatedTagView.self)
    ...
    private(set) var model: RelatedTagViewModel?
    ...
    func setModel(_ model: RelatedTagViewModel) {
        
        self.model = model
        
        self.label.text = model.originalText
        self.label.typography = .som.v2.caption2
