//
//  SearchTermPlaceholderViewCell.swift
//  SOOUM
//
...
class SearchTermPlaceholderViewCell: UICollectionViewCell {
    
    enum Text {
        static let message: String = "검색 결과가 없어요"
    }
    
    static let cellIdentifier = String(reflecting: SearchTermPlaceholderViewCell.self)
